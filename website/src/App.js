    ...
    <div className="App">
      ...
      <div className="mt-16 flex flex-col items-center justify-center ">
        ...
        <Button
          variant="large"
          size="large"
          onClick={() => alert("Botão maior clicado!")}
        >
          Button
        </Button>
        <br />
        ...
        <Button
          variant="extraLarge"
          size="extraLarge"
          onClick={() => alert("Botão extra grande clicado!")}
        >
          Button
        </Button>
        <br />
        ...
        <Button onClick={() => alert("Botão com ícone clicado!")}>
          ...
          {/* Ícone adicionado ao lado do texto */}
          Button
        </Button>
        <br />
        <br />
        ...
        <Button
          ...
          onClick={() => alert("Botão outline default clicado!")}
        >
          Button
        </Button>
        <br />
        ...
        <Button
          ...
          size="large"
          onClick={() => alert("Botão outline large clicado!")}
        >
          Button
        </Button>
        <br />
        ...
        <Button
          variant="outlineExtraLarge"
          size="extraLarge"
          onClick={() => alert("Botão outline extra grande clicado!")}
        >
          Button
        </Button>
        <br />
        ...
        <Button
          variant="outlineDefault"
          onClick={() => alert("Botão default com ícone purple clicado!")}
        >
          <PlusIconPurple className="mr-2 w-4 h-4" />{" "}
          {/* Ícone Purple adicionado ao lado do texto */}
          Button
        </Button>
        <br />
        <br />
        ...
        <Button
          variant="outlineLarge"
          size="large"
          onClick={() => alert("Botão large com ícone purple clicado!")}
        >
          <PlusIconPurple className="mr-2 w-4 h-4" />{" "}
          {/* Ícone Purple adicionado ao lado do texto */}
          Button
        ...
        <Button
          variant="outlineExtraLarge"
          size="extraLarge"
          onClick={() => alert("Botão extra grande com ícone purple clicado!")}
        >
          <PlusIconPurple className="mr-2 w-4 h-4" />{" "}
          {/* Ícone Purple adicionado ao lado do texto */}
          Button
        ...
        <Button
          variant="google"
          size="google"
          onClick={() => alert("Login com Google clicado!")}
        >
      ...
      <h2 className="text-center font-bold text-[18px] font-['Plus Jakarta Sans']">
