...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-center", 
  {
    variants: {
      variant: {
        default: "bg-[#7065F0] text-white hover:bg-[#5a50c2]",
        large: "bg-[#7065F0] text-white hover:bg-[#5a50c2]",
        extraLarge: "bg-[#7065F0] text-white hover:bg-[#5a50c2]",
        outline: "border border-purple-600 text-purple-600 hover:bg-purple-100",
        outlineDefault: "border-2 border-[#E0DEF7] text-[#7065F0] hover:bg-[#E0DEF7]/20",
        outlineLarge: "border-2 border-[#E0DEF7] text-[#7065F0] hover:bg-[#E0DEF7]/20",
      ...
      size: {
        ...
        large: "h-14 px-8 py-3 rounded-lg text-lg leading-[1.5] font-bold font-['Plus Jakarta Sans']",
        extraLarge: "h-16 px-10 py-4 rounded-lg text-xl leading-[1.5] font-bold font-['Plus Jakarta Sans']",
        xxLarge: "h-20 px-12 py-5 rounded-lg text-2xl leading-[1.5] font-bold font-['Plus Jakarta Sans']",
